 ...
 */
const getAllUpcomingMeetup = () => {
  showOverlay();
  // meetup endpoint url
  const url = 'https://meet-up-questioner.herokuapp.com/api/v1/meetups/upcoming/';
  ...
  fetch(url, {
    ...
    .then((body) => {
      ...
      if (body.status === 200) {
        ...
        const meetupContainer = document.getElementById('all-upcoming-meetup-container');
